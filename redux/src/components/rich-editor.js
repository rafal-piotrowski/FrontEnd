...
// import { formsSelector } from '../redux/reducers/forms.js';
import { filterFormSelector } from '../redux/reducers/forms.js';

export class RichEditor extends connect(store)(LitElement) {
// export class RichEditor extends LitElement {
    ...
    stateChanged(state) {
        // if (this.page != state.forms.page) {
        //     this.page = state.forms.page;
        // }

        // if (this.formContent != state.forms.formvalues) {
        //     this.formContent = state.forms.formvalues;
        // }

        // if (this.formContent != formsSelector(state)) {
        //     this.formContent = formsSelector(state);
        // }

        if (this.formContent != filterFormSelector(state)) {
            this.formContent = filterFormSelector(state);
        }
    }

...
// SLOT to zarezerwowany obszar w szablonie HTML który może zostać wypełniony innym komponentem

class MyTempslotComponent extends HTMLElement {
	constructor() {
		super();
...
customElements.define('my-tempslot-component', MyTempslotComponent);
